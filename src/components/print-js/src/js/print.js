...
const Print = {
  send: (params, printFrame) => {
    ...
    // printFrame=' <link rel="stylesheet" href="./static/css/main.css">'+printFrame
    ...
    iframeElement.onload = () => {
      ...
      if (Browser.isIE()){
        if (params.css) {
          const linkElement = document.createElement('link');//printDocument.getElementsByTagName('head')[0].innerHTML;
