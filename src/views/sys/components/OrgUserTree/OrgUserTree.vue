<template>
  <el-container>
    <el-aside class="map-tree-wrapper" style="width: 20%">
     <!-- <el-header><span style="font-size: 20px; color: #999;  text-align:center; ">组织维护</span></el-header> -->
      <el-tree class="map-tree" ref="tree" :props="props"  check-strictly :load="getTreeList" lazy node-key="id"
     ...
     <el-container  style="height: 80%">
      ...
      <!--引入用户人员组件  -->
      <el-main>
       <SysUser  :dept-data="deptData" :ispd="ispd" ref="SysUser"></SysUser>
      </el-main>
   </el-container>
  </el-container>
</template>
...
<script>
 import SysUser from '@/views/sys/components/OrgUserTree/SysUser'; //引入用户人员组件 @selectOrgList="selectOrgList"
    export default {
      name: "OrgTree",
      components:{SysUser},
      props:{
      ...
      methods: {
        //获取人员组件列表选中的数据
        getUsers(){
          return this.$refs.SysUser.getUserList()
        },
