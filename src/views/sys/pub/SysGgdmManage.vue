    ...
    <div>
        ...
        <div class="map-search-bar">
            <el-form label-width="110px" :model="searchSysTypegroupForm" class="clear">
                ...
                <el-form-item class="w25" label="公共代码">
                    <el-input v-model="searchSysTypegroupForm.typegroupcode" placeholder="公共代码"></el-input>
                </el-form-item>

                <el-form-item class="w25" label="代码名称">
                    <el-input v-model="searchSysTypegroupForm.typegroupname" placeholder="代码名称"></el-input>
                </el-form-item>

           <!--     <el-form-item class="w25" label="模块代码">
              <el-select v-model="searchSysTypegroupForm.busiType" clearable placeholder="请选择">
                <el-option
                ...
                <el-form-item class="w25" label="代码类型">
              <el-select v-model="searchSysTypegroupForm.dropType" clearable placeholder="请选择">
                <el-option
        ...
        <div class ="map-table">
            <el-table ref="tableSysTypegroup" @row-click="rowClickSysTypegroup" :data="tableSysTypegroup.tableData" :height="tableHeight"
                ...
                <el-table-column prop="typegroupcode" label="公共代码"   width="220"></el-table-column>

                <el-table-column prop="typegroupname" label="代码名称"  ></el-table-column>

               <!-- <el-table-column prop="busiTypeLabel" label="模块代码"   width="120"></el-table-column>-->

                <el-table-column prop="dropTypeLabel" label="代码类型"   width="120"></el-table-column>

                <el-table-column prop="dropSql" label="下拉sql"   ></el-table-column>
        ...
        <div class="map-pagination">
            <el-pagination
                ...
                <!-- 新增页弹窗 -->
        <div class="map-form">
            <el-dialog :title="formSysTypegroupTitle"  width="80%" top="10Vh"  height="tableHeight" :visible.sync="dialogSysTypegroupFormVisible" v-if="dialogSysTypegroupFormVisible">
                <el-tabs  v-model="activeName" >
                 <el-tab-pane label="基本信息" name="first">
                <el-form :rules="formSysTypegroupRules" ref="formSysTypegroup" :model="formSysTypegroup" :disabled=isSysTypegroupDisabled class="clear dialog-form"  label-width="100px" style="height: 500px">

                    <el-form-item verify  class="w25" prop="typegroupcode" label="公共代码">
                        <el-input  v-model="formSysTypegroup.typegroupcode" autocomplete="off"></el-input>
                    </el-form-item>

                    <el-form-item verify class="w25" prop="typegroupname" label="代码名称">
...
<!--                        <el-select v-model="formSysTypegroup.busiType" clearable placeholder="请选择">-->
<!--                            <el-option-->
<!--                                    v-for="item in dictsSysTypegroup.busiType"-->
<!--                                    :key="item.value"-->
<!--                                    :label="item.text"-->
...
<!--                    </el-form-item>-->
                    ...
                    <el-form-item verify class="w25" prop="dropType" label="代码类型">
                        <el-select v-model="formSysTypegroup.dropType" placeholder="请选择" @change="changeDrop">
                            <el-option
                                    v-for="item in dictsSysTypegroup.dropType"
                                    :key="item.value"
                                    :label="item.text"
            ...
            goUpdateSysTypegroup(isSysTypegroupDisabled,rowData) {
              ...
              if(isSysTypegroupDisabled){
               this.isShowbtn = false //子表是否显示保存按钮
                this.formSysTypegroupTitle="查看公共代码";
              this.isShowSave=false
              }else {
               this.isShowbtn = true //子表是否显示保存按钮
                this.formSysTypegroupTitle="修改公共代码";
